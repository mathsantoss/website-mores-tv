...
export default function GoogleReviewsSection() {
  return (
    ...
    <section className="bg-[#f1f0fb] py-8 px-2 sm:px-0 flex flex-col items-center w-full overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row w-full max-w-5xl justify-center items-stretch gap-6">
        ...
        {/* <div className="flex-1 flex flex-col items-center gap-4"> */}
          {/* <div className="flex justify-center gap-4 w-full"> */}
            <div className="flex-1 flex flex-col items-center gap-4 w-full overflow-x-auto pb-4">
              <div className="flex justify-center gap-4 w-full flex-wrap md:flex-nowrap px-2">
              {FAKE_GOOGLE_REVIEWS.map((r, i) => (
                ...
                <div key={i} className="relative flex flex-col gap-3 bg-white rounded-xl shadow p-5 w-[290px] max-w-full shrink-0 md:shrink">
